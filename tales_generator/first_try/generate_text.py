...
tokenizer = AutoTokenizer.from_pretrained(r"C:\Users\Eugene\Google Диск\GPT-3\test\test3")
model = GPT2LMHeadModel.from_pretrained(r"C:\Users\Eugene\Google Диск\GPT-3\test\test3")
...
def generate(input_context):
    ...
    outputs = model.generate(input_ids=input_ids, max_length=2048, do_sample=True)
